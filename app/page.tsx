        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="grid gap-4 sm:gap-6 md:grid-cols-3 text-center">
              ...
              <div className="bg-white/10 backdrop-blur rounded-lg p-4 sm:p-6">
                <div className="text-2xl sm:text-3xl font-bold mb-2">Aug 31</div>
            ...
            <Card className="border-2 border-red-200 bg-red-50/50">
              ...
              <CardContent>
                <div className="text-center p-4 sm:p-6 bg-white rounded-lg border-2 border-red-200">
                  <div className="text-2xl sm:text-3xl font-bold text-red-600 mb-2">August 31st</div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="flex items-center space-x-2">
                ...
                <img
                  src="https://lnmiit.ac.in/wp-content/uploads/2023/07/LNMIIT-Logo-Transperant-Background.png"
                  alt="LNMIIT Logo"
                  className="h-7 w-auto sm:h-9 sm:w-auto md:h-11 md:w-auto object-contain"
                />
              </div>
